                                    ...
                                    <div class="row" style="">
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <select wire:model="year" class="custom-select mr-sm-2 @error('year') input-error @enderror" >
                                                <option  value="">{{trans('trans_school.Year')}}</option>
                                            @for($i = 2000 ; $i <= 2020 ; $i++)
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <select wire:model="month" class="custom-select mr-sm-2 @error('month') input-error @enderror" >
                                                <option  value="">{{trans('trans_school.Month')}}</option>
                                                @for($i = 01 ; $i <= 12 ; $i++)
                                                    <option value="{{$i}}">{{$i}}</option>
                                                @endfor
                                            </select>
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            ...
                                            <option  value="">{{trans('trans_school.Day')}}</option>
                                            @for($i = 01 ; $i <= 31 ; $i++)
                                                <option value="{{$i}}">{{$i}}</option>
                                            @endfor
                                            </select>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select wire:change="change_in_classes" wire:model="Classroom_id" class="custom-select mr-sm-2 selected_select @error('Classroom_id') input-error @enderror" >
                                        @if(!empty($my_classes))
                                        <option selected >{{trans('trans_school.Choose')}}...</option>
                        ...
                        <button wire:click="EditStudentInDatabase" class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('trans_school.Submit')}}</button>
