...
@section('css')
    @toastr_css
@section('title')
{{trans('trans_school.Add_a_new_article')}}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> {{trans('trans_school.Add_a_new_article')}}</h4>
        </div>
        <div class="col-sm-6">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{route('Subjects.store')}}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">@lang('trans_school.Article_name_in_Arabic')</label>
                                        <input type="text" name="name_ar" class="form-control">
                                    </div>
                                    <div class="col">
                                        <label for="title">{{trans('trans_school.Article_name_in_English')}}</label>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        <label for="inputState">{{trans('trans_school.classrooms')}}</label>
                                        <select name="Class_id" class="custom-select"></select>
                                    </div>


                                    <div class="form-group col">
                                        <label for="inputState">{{trans('trans_school.name_teacher')}}</label>
