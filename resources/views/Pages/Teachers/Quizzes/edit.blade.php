                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="Grade_id_teacher">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="Classroom_id_teacher">
                                                <option value="{{$quizz->classroom_id}}">{{$quizz->class_rooms->name_class}}</option>                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="section_id_teacher">
                                                <option value="{{$quizz->section_id}}">{{$quizz->sections->name_section}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div><br>
