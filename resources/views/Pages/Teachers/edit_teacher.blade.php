...
@section('css')
    @toastr_css
@section('title')
    {{ trans('trans_school.edit_teacher') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> {{trans('trans_school.edit_teacher')}}</h4>
        </div>
        <div class="col-sm-6">
                ...
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <label for="title">{{trans('trans_school.teacher_name_ar')}}</label>
                                ...
                                <div class="col">
                                    <label for="title">{{trans('trans_school.teacher_name_en')}}</label>
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    <label for="inputCity">{{trans('trans_school.specialization')}}</label>
                                    <select class="custom-select my-1 mr-sm-2" name="Specialization_id">
                                        <option selected  value={{$Teacher->specialization_id}}>{{$Teacher->specializations->name}}</option>
                                ...
                                <div class="form-group col">
                                    <label for="inputState">{{trans('trans_school.gender')}}</label>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <label for="title">{{trans('trans_school.joining_date')}}</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="Address" value="{{$Teacher->address}}" id="exampleFormControlTextarea1" rows="4"></textarea>
                                @error('Address')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>

                            <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('trans_school.Next')}}</button>
                    </form>
                        </div>
                    </div>
                </div>
